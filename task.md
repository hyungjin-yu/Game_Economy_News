# Game Dev News Notifier

- [x] 프로젝트 설정 및 기획
    - [x] 요구사항 분석 및 기술 스택 선정
    - [x] `implementation_plan.md` 작성
- [x] 뉴스 수집 모듈 구현
    - [x] RSS 피드 파싱 (Game Developer, GamesIndustry.biz 등)
    - [x] 뉴스 기사 데이터 구조화 (제목, 링크, 내용)
- [x] 요약 모듈 구현
...
- [x] 테스트 및 검증
    ...
    - [x] 디스코드 전송 테스트
- [x] 배포 및 최적화
    - [x] 윈도우 작업 스케줄러 등록 스크립트 작성 (`setup_scheduler.bat`)
    - [x] 로그 파일 기록 기능 추가 (`main.py`)
